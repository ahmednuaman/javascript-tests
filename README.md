# JavaScript Tests [![Build Status](https://travis-ci.org/eSynergySolutions/javascript-tests.svg?branch=master)](https://travis-ci.org/eSynergySolutions/javascript-tests)
